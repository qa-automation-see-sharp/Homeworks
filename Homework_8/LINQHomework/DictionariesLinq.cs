...
public class DictionariesLinq : StartUpFixture
{
    ...
    public void First()
    {
        ...
        // Query
        var result = teachers
            .Where(t => t.Value.Subject == "Math" && t.Value.Experience > 10)
            .Select(t => t.Value.Name).OrderByDescending(t => t)
            .ToList();
    ...
    public void Second()
    {
        ...
        // Query
        var result = courses
            .Where(c => c.Value.Credits > 3 && c.Value.Students.Any())
            .Select(c => c.Value)
            .OrderBy(c => c.Title)
            .ToList();
    ...
    public void Fourth()
    {
        ...
        // Query
        var result = movies.First(m => m.Value.Duration > 150).Value.Title;
    ...
    public void Fifth()
    {
        ...
        // Query
        var result = employees.Any(e => e.Value.Salary > 60000 && e.Value.Department == "IT");
